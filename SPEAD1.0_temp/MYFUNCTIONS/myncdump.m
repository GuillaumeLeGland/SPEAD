function [theVarnames] = ncdump(theNetCDFFile, theOutputFile)
...
if ischar(theOutputFile) & fp > 2 
    fclose(fp); 
end
close(nc)
if nargout > 0 
% $$$     theStatus = status; %this variable does *not* exists so I dont understand...
