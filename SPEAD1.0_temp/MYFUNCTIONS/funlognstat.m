function [m,v]= funlognstat(mu,sigma);
...
if nargin < 2
    error('stats:lognstat:TooFewInputs','Requires at least two input arguments.');
end
...
try
    ...
    error('stats:lognstat:InputSizeMismatch','Non-scalar arguments must match in size.');
end
