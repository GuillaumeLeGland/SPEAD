...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Name: myLatexTicks.m (orinally called "Format_Ticks.m")
%
%Usage: [hx,hy] = myLatexTicks(h,tickx,ticky,tickposx,tickposy,rotx,roty,offset,varargin);
%
...
%
%       ;Example 2: Append Degree Symbolts to X and Y Axes of a Plot and put a 45 degree tilt on them:
%       figure;
%       plot(1:10,1:10);
...
%                 [],[1,2.5,9.5]);
%
%       ;Example 4: Make a plot with degrees on y tick label and fractions on x:
%       figure 
%       plot(0:10,0:10);
%       [hx,hy] = format_ticks(gca,...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [hx,hy] = myLatexTicks(h,tickx,ticky,tickposx,tickposy,rotx,roty,offset,varargin)
...
elseif ~iscell(tickx );
    warning(['Input TICKX variable is not a compatible string or cell array! Returning...']);
    return;
end;
