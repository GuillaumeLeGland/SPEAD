function [conv_P,conv_xave,conv_yave,conv_xxvar,conv_yyvar,conv_xycor] = SPEAD_1D_convergence_check(P,xave,yave,xxvar,yyvar,xycov,ndays)
% Check if the simulation is convergent using variations between years
