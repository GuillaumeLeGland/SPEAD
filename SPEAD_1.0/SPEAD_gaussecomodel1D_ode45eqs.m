...
if sum(galfa ~= 1) ~= 0    
    ...
    for i=1:ndepths
       ...
       % use the backslash \ operator instead of inverse matrix, to increase precision and decrease computational costs
...
%...................................................................................
% 01/03/2021: Error corrected: a factor "2" was missing in the expression of the second right hand term
% of dXXVARdt and dYYVARdt
dXXVARdt = (xxvar.^2) .* (d2uxydxdx - d2gxydxdx) + 2*(xxvar.*xycov) .* (d2uxydxdy - d2gxydxdy) + ...
           (xycov.^2) .* (d2uxydydy - d2gxydydy) + numutx .* (2.*uxy);
...
dYYVARdt = (xycov.^2) .* (d2uxydxdx - d2gxydxdx) + 2*(yyvar.*xycov) .* (d2uxydxdy - d2gxydxdy) + ...
           (yyvar.^2) .* (d2uxydydy - d2gxydydy) + numuty .* (2.*uxy);
